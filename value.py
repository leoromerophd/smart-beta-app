...
def show():
    st.title(":ferris_wheel: Value :chart_with_upwards_trend:" )
    etf_name = "Value"
    ...
    if product_number:
        ...
        if download_csv(product_number):
           ...
           # Botón para descargar datos históricos y mostrar rendimientos y riesgo
            if st.button(f'Cálculo de Rendimiento - Riesgo para el índice de Valor'):
                with st.spinner('... Calculando ...'):
                    ...
                    # -------Creación de la gráfica de burbujas para Alpha Anual vs Riesgo Anual
